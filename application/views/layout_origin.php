...
<html class="no-js"><!--<![endif]-->
  <head>
    ...
    <!-- Modernizr -->
    <script src="<?php echo base_url('groundwork')?>/js/libs/modernizr-2.6.2.min.js"></script>
    <!-- jQuery-->
    <script type="text/javascript" src="<?php echo base_url('groundwork')?>/js/libs/jquery-1.10.2.min.js"></script>
    <!-- framework css --><!--[if gt IE 9]><!-->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork.css"><!--<![endif]--><!--[if lte IE 9]>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork-core.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork-type.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork-ui.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork-anim.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/groundwork-ie.css"><![endif]-->
    <style type="text/css">
      .logo {
        position: relative;
        top: -0.5em;
    ...
    <script type="text/javascript" src="<?php echo base_url('groundwork')?>/js/demo/jquery.snippet.min.js"></script>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('groundwork')?>/css/demo/jquery.snippet.css"><script type="text/javascript">
(function() {

  $(document).ready(function() {
    $('pre[data-lang="html"]').snippet("html", {
      style: "groundwork",
      clipboard: "<?php echo base_url('groundwork')?>/js/demo/ZeroClipboard.swf"
    });
  ...
  <body>
    <header class="padded">
      <div class="container">
        <div class="row">
          <div class="one half">
            <h2 class="logo"><a href="/" target="_parent"><img src="<?php echo base_url('groundwork')?>/images/groundwork-logo.svg" alt="GroundworkCSS">GroundworkCSS 2</a></h2>
          </div>
          <div class="one half">
        ...
        <nav role="navigation" class="nav gap-top">
          <ul role="menubar">
            <li><a href="<?php echo base_url('groundwork')?>/docs/home.html"><i class="icon-home"></i> Home</a></li>
            <li role="menu">
              <button>Example Layouts</button>
              <ul>
                <li><a href="<?php echo base_url('groundwork')?>/docs/layout-a.html">Web Page</a></li>
                <li><a href="<?php echo base_url('groundwork')?>/docs/layout-b.html">Image Gallery</a></li>
                <li><a href="<?php echo base_url('groundwork')?>/docs/layout-c.html">Ecommerce Page</a></li>
              </ul>
            </li>
            <li role="menu">
    ...
    <!-- javascript-->
    <script type="text/javascript" src="<?php echo base_url('groundwork')?>/js/groundwork.all.js"></script>
  </body>
</html>